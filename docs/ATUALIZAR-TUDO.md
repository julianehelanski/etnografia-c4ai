...
python infranodus\tese_documento.py --source-root $tese --inject index.html # resumo·sumário
python infranodus\tese_referencias.py --source-root $tese --inject index.html # referências citadas
