...
| 6 | `unidos` | 112 | 101 | +11 |
| 7 | `vida` | 151 | 141 | +10 |
| 8 | `computacional` | 90 | 81 | +9 |
| 9 | `lado` | 108 | 100 | +8 |
| 10 | `translacao` | 117 | 109 | +8 |
| 11 | `objeto` | 126 | 118 | +8 |
| 12 | `tecnociencia` | 127 | 119 | +8 |
| 13 | `dinheiro` | 131 | 124 | +7 |
| 14 | `gesto` | 153 | 146 | +7 |
...
- **Tópico 1** (42 termos): publico, corporacao, instituicao, tecnologia, infraestrutura, modelo
- **Tópico 2** (32 termos): hollerith, trajetoria, maquina, tabulacao, empresa, historica
- **Tópico 3** (29 termos): claudio, rede, fabio, seguir, ator, porta
- **Tópico 4** (27 termos): pesquisa, centro, cientifico, etnografia, relatorios, pergunta
- **Tópico 5** (18 termos): arranjo, laboratorio, brasil, encerramento, parte, dezembro
- **Tópico 6** (17 termos): fapesp, informacao, verbal, pinhanez, recursos, financiamento
- **Tópico 7** (8 termos): ponto, estados, passagem, deixa, unidos, translacao
- **Tópico 8** (7 termos): inteligencia, artificial, acesso, brasileiro, obia, disponivel

## 8. Lacunas estruturais (pares de tópicos fracamente conectados)
Lacunas estruturais sinalizam *espaços de ideia* pouco articulados no
texto — candidatos a aprofundamento argumentativo.

- Lacuna entre **Tópico 2** [hollerith, trajetoria, maquina] e **Tópico 5** [arranjo, laboratorio, brasil] — densidade ponderada de ligação = 0.2604
- Lacuna entre **Tópico 2** [hollerith, trajetoria, maquina] e **Tópico 4** [pesquisa, centro, cientifico] — densidade ponderada de ligação = 0.3079
- Lacuna entre **Tópico 2** [hollerith, trajetoria, maquina] e **Tópico 3** [claudio, rede, fabio] — densidade ponderada de ligação = 0.3621
- Lacuna entre **Tópico 1** [publico, corporacao, instituicao] e **Tópico 3** [claudio, rede, fabio] — densidade ponderada de ligação = 0.3941
- Lacuna entre **Tópico 1** [publico, corporacao, instituicao] e **Tópico 2** [hollerith, trajetoria, maquina] — densidade ponderada de ligação = 0.4449
- Lacuna entre **Tópico 3** [claudio, rede, fabio] e **Tópico 5** [arranjo, laboratorio, brasil] — densidade ponderada de ligação = 0.4464
